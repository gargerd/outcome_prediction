                ...
                for training_data_type in training_data_type_:
                     ...
                     for ther_arm_dur in ther_arm_durations_:
                        ...
                        for cv_repeat_num in range(train_params['num_cv_repeats']):
                            ...
                            print(f'{data_param_key} - {training_data_type} - period:{period_end_day} - model: {model_name} - {ther_arm_dur} cohort - {time_origin} - {X_train.shape[1]} vars - Num of CV-repeat:{cv_repeat_num+1}')
                            ...
                            for n in tqdm(range(num_of_top_models_per_cv),desc="Processing", unit="model"):
                                ...
                                if is_pycox_model(model_name)==True:
                                    training_results['cv_results'][f'cv_rep_{cv_repeat_num}']['model'][n]={
                                                                                                ...
                                                                                                "labtrans": model_bundle['labtrans'],
                                                                                                "state_dict": model_bundle['model'].net.state_dict()
                                                                                            }
