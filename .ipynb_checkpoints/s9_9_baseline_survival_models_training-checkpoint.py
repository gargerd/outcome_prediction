            ...
            for training_data_type in training_data_type_:
                 ...
                 for ther_arm_dur in ther_arm_durations_:
                    ...
                    for cv_repeat_num in range(train_params['num_cv_repeats']):
                        ...
                        print(f'{data_param_key} - {training_data_type} - period:{period_end_day} - model: {model_name} - {ther_arm_dur} cohort - {X_train.shape[1]} vars - Num of CV-repeat:{cv_repeat_num+1}')
